...
combination. Together, they form an iterator algebra making it possible to construct specialized tools succinctly and
...
lista = list(combinations(list_a, int(k)))
counter = 0
for i in lista:
    if 'a' in i:
        counter += 1

print('{:.3f}'.format(counter/len(lista)))
